h1. ThingSpeak (with rate limits and memcached support)
...
h2. (Optional) Rate Limit POSTs

Change the "14.seconds" to whatever you like in line 100 of app/controllers/channels_controller.rb
